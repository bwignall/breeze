...
class DesignFilterTest extends AnyFunSuite {
  ...
  test("designFilterFirwin tested against output from scipy.signal.firwin (0.13.2-1)") {
    ...
    val firwin1 = designFilterFirwin[Double](6,
                                             DenseVector(0.5),
                                             nyquist = 1d,
                                             zeroPass = true,
                                             scale = true,
    ...
    val firwin2 = designFilterFirwin[Double](3,
                                             DenseVector(10.0),
                                             nyquist = 15.0,
                                             zeroPass = true,
                                             scale = false,
    ...
    val firwin3 = designFilterFirwin[Double](5,
    ...
    val firwin4 = designFilterFirwin[Double](4,
                                             DenseVector(1.0, 8.0),
                                             nyquist = 10.0,
                                             zeroPass = false,
                                             scale = false,
    ...
    val firwin5 = designFilterFirwin[Double](5,
                                             DenseVector(4.0, 9.0),
                                             nyquist = 10.0,
                                             zeroPass = true,
                                             scale = false,
  ...
  val testFirwin1: DenseVector[Double] = DenseVector(-0.0077763127191025679, 0.064454645578710029, 0.44332166714039256, 0.44332166714039256,
  ...
  val testFirwin3: DenseVector[Double] = DenseVector(-0.018510492178744953, -0.01461577162249808, 0.26666666666666661, -0.01461577162249808,
  ...
  val testFirwin5: DenseVector[Double] = DenseVector(-2.596504355380610970e-18, 6.948495923029152088e-02, 4.999999999999998335e-01,
                                6.948495923029154864e-02, -2.596504355380610970e-18)
