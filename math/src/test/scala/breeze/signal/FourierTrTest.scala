...
class FourierTrTest extends AnyFunSuite {
  ...
  private val test16C: DenseVector[Complex] = DenseVector[Complex](
  ...
  private val test16fftC: DenseVector[Complex] = DenseVector[Complex](
  ...
  private val test16ifftC: DenseVector[Complex] = DenseVector[Complex](
  ...
  private val test5x5: DenseMatrix[Double] = DenseMatrix(
  ...
  private val test5x5C: DenseMatrix[Complex] = DenseVector[Complex](
  ...
  private val test5x5fftC: DenseMatrix[Complex] = DenseVector[Complex](
  ...
  private val test5x5ifftC: DenseMatrix[Complex] = DenseVector[Complex](
