...
//    assert(z === DenseMatrix((164.0,5.0,107.0),(-5.0,10.0,-27.0),(161.0,-7.0,138.0)))
  ...
  test("Multiply Complex") {
    ...
    val a = Matrix((Complex(1, 1), Complex(2, 2), Complex(3, 3)), (Complex(4, 4), Complex(5, 5), Complex(6, 6)))
...
//    assert(b.t * c === DenseVector(Complex(72,-72), Complex(-18,18), Complex(65,-65)))
  ...
  test("Other complex") {
    ...
    assert(a === Matrix((Complex(2, 2), Complex(3, 3), Complex(4, 4)), (Complex(5, 5), Complex(6, 6), Complex(7, 7))))

    a -= Complex(1, 1)

    assert(a === Matrix((Complex(1, 1), Complex(2, 2), Complex(3, 3)), (Complex(4, 4), Complex(5, 5), Complex(6, 6))))
  }
