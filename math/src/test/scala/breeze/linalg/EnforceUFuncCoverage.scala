...
object EnforceUFuncCoverage {
  ...
  implicit def vectorsAndMatrices1[F <: UFunc](f: F)(implicit
    wV: Witness[F, One, Vector.type],
    wM: Witness[F, One, Matrix.type]
  ): Witness[F, One, Vector.type with Matrix.type] = null

  implicit def linalg1[F <: UFunc](f: F)(implicit
    wV: Witness[F, One, Vector.type],
    wM: Witness[F, One, Matrix.type],
    wC: Witness[F, One, Counter.type]
  ): Witness[F, One, Tensor.type] = null
