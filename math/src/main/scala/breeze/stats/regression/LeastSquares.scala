...
object leastSquares extends UFunc {
  implicit val matrixVectorWithWorkArrayDouble
    ...
    (data: DenseMatrix[Double], outputs: DenseVector[Double], workArray: Array[Double]) =>
  ...
  implicit val matrixVectorWithWorkArrayFloat
    ...
    (data: DenseMatrix[Float], outputs: DenseVector[Float], workArray: Array[Float]) =>
  ...
  implicit val matrixVectorSpecifiedWorkDouble
    ...
    (data: DenseMatrix[Double], outputs: DenseVector[Double], workSize: Int) =>
  ...
  implicit val matrixVectorSpecifiedWorkFloat
    ...
    (data: DenseMatrix[Float], outputs: DenseVector[Float], workSize: Int) =>
  ...
  implicit val matrixVectorDouble
    ...
    (data: DenseMatrix[Double], outputs: DenseVector[Double]) =>
      leastSquaresImplementation.doLeastSquaresDouble(data.copy,
                                                      outputs.copy,
  ...
  implicit val matrixVectorFloat: Impl2[DenseMatrix[Float], DenseVector[Float], LeastSquaresRegressionResult[Float]] =
    (data: DenseMatrix[Float], outputs: DenseVector[Float]) =>
      leastSquaresImplementation.doLeastSquaresFloat(data,
                                                     outputs,
...
object leastSquaresDestructive extends UFunc {
  ...
  implicit val matrixVectorDouble
    : Impl2[DenseMatrix[Double], DenseVector[Double], LeastSquaresRegressionResult[Double]] =
    (data: DenseMatrix[Double], outputs: DenseVector[Double]) =>
      leastSquaresImplementation.doLeastSquaresDouble(data,
                                                      outputs,
                                                      new Array[Double](math.max(1, data.rows * data.cols * 2))
      )
