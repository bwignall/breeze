...
trait Counter2Ops {
  ...
  private def binaryOpFromBinaryUpdateOp[K1, K2, V, Other, Op <: OpType](implicit
    ...
    new UImpl2[Op, Counter2[K1, K2, V], Other, Counter2[K1, K2, V]] {
      override def apply(a: Counter2[K1, K2, V], b: Other): Counter2[K1, K2, V] = {
        val c = copy(a)
        op(c, b)
        c
      }
  ...
  implicit def canMulVS[K1, K2, V](implicit
    semiring: Semiring[V]
  ): OpMulScalar.Impl2[Counter2[K1, K2, V], V, Counter2[K1, K2, V]] = { (a: Counter2[K1, K2, V], b: V) =>
    {
      val r = Counter2[K1, K2, V]()
      for ((k, v) <- a.activeIterator) {
        val vr = semiring.*(v, b)
  ...
  implicit def canMulVS_M[K1, K2, V](implicit
    semiring: Semiring[V]
  ): OpMulMatrix.Impl2[Counter2[K1, K2, V], V, Counter2[K1, K2, V]] = { (a: Counter2[K1, K2, V], b: V) =>
    {
      val r = Counter2[K1, K2, V]()
      for ((k, v) <- a.activeIterator) {
        val vr = semiring.*(v, b)
  ...
  implicit def canDivVS[K1, K2, V](implicit
    copy: CanCopy[Counter2[K1, K2, V]],
    semiring: Field[V]
  ): OpDiv.Impl2[Counter2[K1, K2, V], V, Counter2[K1, K2, V]] = { (a: Counter2[K1, K2, V], b: V) =>
    {
      val r = Counter2[K1, K2, V]()
      for ((k, v) <- a.activeIterator) {
        val vr = semiring./(v, b)
  ...
  implicit def zipMap[K1, K2, V, R: Zero: Semiring]: CanZipMapValuesCounter2[K1, K2, V, R] =
    new CanZipMapValuesCounter2[K1, K2, V, R]
}
