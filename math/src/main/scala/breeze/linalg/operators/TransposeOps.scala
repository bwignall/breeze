...
trait TransposeOps_LowPrio extends TransposeOps_LowPrio2 {
  ...
  implicit def impl_OpMulMatrix_Ut_T_from_Tt_U[T, TT, U, R, RT](implicit
    ...
    (v: Transpose[U], v2: T) => canTranspose(op(transT(v2), v.inner))
  }
