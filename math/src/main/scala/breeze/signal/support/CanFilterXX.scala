...
object CanFilterBPBS {
  ...
  implicit val dvDouble1DFilterBPBS: CanFilterBPBS[DenseVector[Double], DenseVector[Double]] = {
    (data: DenseVector[Double], omega: (Double, Double), sampleRate: Double, taps: Int, bandStop: Boolean, kernelType: OptDesignMethod, overhang: OptOverhang, padding: OptPadding) => {
...
object CanFilterLPHP {
  ...
  implicit val dvDouble1DFilterLPHP: CanFilterLPHP[DenseVector[Double], DenseVector[Double]] = {
    (data: DenseVector[Double], omega: Double, sampleRate: Double, taps: Int, lowPass: Boolean, kernelType: OptDesignMethod, overhang: OptOverhang, padding: OptPadding) => {
